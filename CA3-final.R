...
# selecting the row which has station name "Letterkenny 
crime_location<- crime[which(crime$Station == "Letterkenny"),]
...
# performing shapiro normality test
normality_test <- shapiro.test(final_location$crime_count)
normality_test$p.value

# Plotting the values in the dataset
